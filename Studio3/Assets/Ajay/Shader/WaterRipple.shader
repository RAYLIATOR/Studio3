...
Shader "Custom/WaterRipple" {
	Properties {
		...
		_WaveAmp1 ("WaveAmp1", float) = 0
  		_WaveAmp2 ("WaveAmp1", float) = 0
  		_WaveAmp3 ("WaveAmp1", float) = 0
  		_WaveAmp4 ("WaveAmp1", float) = 0
  		_WaveAmp5 ("WaveAmp1", float) = 0
  		_WaveAmp6 ("WaveAmp1", float) = 0
  		_WaveAmp7 ("WaveAmp1", float) = 0
  		_WaveAmp8 ("WaveAmp1", float) = 0

		_xImpact1 ("x Impact 1", float) = 0
  		_zImpact1 ("z Impact 1", float) = 0
		_xImpact2 ("x Impact 2", float) = 0
  		_zImpact2 ("z Impact 2", float) = 0
		_xImpact3 ("x Impact 3", float) = 0
  		_zImpact3 ("z Impact 3", float) = 0
		_xImpact4 ("x Impact 4", float) = 0
  		_zImpact4 ("z Impact 4", float) = 0
		_xImpact5 ("x Impact 5", float) = 0
  		_zImpact5 ("z Impact 5", float) = 0
		_xImpact6 ("x Impact 6", float) = 0
  		_zImpact6 ("z Impact 6", float) = 0
		_xImpact7 ("x Impact 7", float) = 0
  		_zImpact7 ("z Impact 7", float) = 0
		_xImpact8 ("x Impact 8", float) = 0
  		_zImpact8 ("z Impact 8", float) = 0
	...
	SubShader {
		...
		half4 _Color;
		//When one sphere lands on another pos, it should not cause a ripple from the same spot of the previous
		...
		void vert ( inout appdata_full v)
		{
			...
			if(sqrt(pow(worldPos.x - _xImpact1, 2) + pow(worldPos.z - _zImpact1, 2)) < _Distance1)
			{
				...
				v.normal.y += value1 * _WaveAmp1;
				//o.customValue += value1 * _WaveAmp1;
			}
			if(sqrt(pow(worldPos.x - _xImpact2, 2) + pow(worldPos.z - _zImpact2, 2)) < _Distance2)
			{
				...
				//o.customValue += value2 * _WaveAmp2;
			}
			if(sqrt(pow(worldPos.x - _xImpact3, 2) + pow(worldPos.z - _zImpact3, 2)) < _Distance3)
			{
				...
				//o.customValue += value3 * _WaveAmp3;
			}
			if(sqrt(pow(worldPos.x - _xImpact4, 2) + pow(worldPos.z - _zImpact4, 2)) < _Distance4)
			{
				...
				//o.customValue += value4 * _WaveAmp4;
			}
			if(sqrt(pow(worldPos.x - _xImpact5, 2) + pow(worldPos.z - _zImpact5, 2)) < _Distance5)
			{
				...
				//o.customValue += value5 * _WaveAmp5;
			}
			if(sqrt(pow(worldPos.x - _xImpact6, 2) + pow(worldPos.z - _zImpact6, 2)) < _Distance6)
			{
				...
				//o.customValue += value6 * _WaveAmp6;
			}
			if(sqrt(pow(worldPos.x - _xImpact7, 2) + pow(worldPos.z - _zImpact7, 2)) < _Distance7)
			{
				...
				//o.customValue += value7 * _WaveAmp7;
			}
			if(sqrt(pow(worldPos.x - _xImpact8, 2) + pow(worldPos.z - _zImpact8, 2)) < _Distance8)
			{
				...
				//o.customValue += value8 * _WaveAmp8;
			}
		}
